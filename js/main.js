...
var loadedData = {"message":{"header":{"status_code":200,"execute_time":0.032757043838501,"maintenance_id":0},"body":{"track_list":[{"track":{"track_id":82851729,"track_mbid":"","track_isrc":"DEUM71500508","track_spotify_id":"4pPvzPTXbsBWZFTsXEycPi","track_soundcloud_id":0,"track_xboxmusic_id":"music.802FDE08-0100-11DB-89CA-0019B92A3933","track_name":"El Mismo Sol","track_name_translation_list":[],"track_rating":67,"track_length":181,"commontrack_id":46208517,"instrumental":0,"explicit":0,"has_lyrics":1,"has_subtitles":1,"num_favourite":206,"lyrics_id":11325331,"subtitle_id":5485069,"album_id":20762347,"album_name":"El Mismo Sol","artist_id":28668709,"artist_mbid":"","artist_name":"Alvaro Soler","album_coverart_100x100":"http:\/\/s.mxmcdn.net\/images-storage\/albums\/4\/9\/5\/5\/3\/9\/31935594.jpg","album_coverart_350x350":"http:\/\/s.mxmcdn.net\/images-storage\/albums\/4\/9\/5\/5\/3\/9\/31935594_350_350.jpg","album_coverart_500x500":"http:\/\/s.mxmcdn.net\/images-storage\/albums\/4\/9\/5\/5\/3\/9\/31935594_500_500.jpg","album_coverart_800x800":"","track_share_url":"https:\/\/www.musixmatch.com\/lyrics\/Alvaro-Soler\/El-Mismo-Sol","track_edit_url":"https:\/\/www.musixmatch.com\/lyrics\/Alvaro-Soler\/El-Mismo-Sol?utm_source=application&utm_campaign=api&utm_medium=mxm","commontrack_vanity_id":"Alvaro-Soler\/El-Mismo-Sol","restricted":0,"updated_time":"2015-05-18T19:03:38Z","primary_genres":{"music_genre_list":[{"music_genre":{"music_genre_id":1117,"music_genre_parent_id":12,"music_genre_name":"Pop in Spanish","music_genre_name_extended":"Latin \/ Pop in Spanish","music_genre_vanity":"Latin-Pop-in-Spanish"}}]},"secondary_genres":{"music_genre_list":[]}}}]}}};
...
$(document).ajaxStop(function() {
	...
	tagContainer.on('click', function(event){
		if(event.target.classList.contains('tag')) { // User clicked on a tag div
			// if(event.target.classList.contains(SELECTED_TAG_NAME)) {
			// 	deselect(event.target);
			// } else {
			// 	select(event.target, ColorManager.colorManager.getColor());
			// }
	...
	*/
	...
	/*
	* Function : getNewDOMClass(name of tag e.g. div/span/p, name of css class)
	* --------------------------------------------------------------------------
	* Creates and returns new dom element with the specified parameters
	*/
	function getNewDOMClass(tagName, className) {
		var newDOMClass = document.createElement(tagName);
		newDOMClass.className = className;
		return newDOMClass;
	}
